...
public class GCMTestActivity extends AppCompatActivity {
    ...
    private boolean registerGcm(){
        //set the curent user
        Globals.instance().setCurrentUser(SugarRecord.find(User.class, "where id=1").remove(0));
        ...
        Call<User> call = userService.registerWithGcm(currentUser.getId(), idService.getToken());
